...
label_6500 = mydbscan(RH_vertex_6500, 5, 0.35);
disp('label_6500:');
...
disp(['noise: ' num2str(noise) '%']);
class1 = (numel(find(label_9180240 == 1)) / numel(label_9180240))*100;
disp(['class1: ' num2str(class1) '%']);
disp(' ');
...
label_9211105 = mydbscan(RH_vertex_9211105, 5, 0.3);
disp('label_9211105:');
...
tabel(6,1) = 50; tabel(6,2) = 150; tabel(6,3) = 85;
