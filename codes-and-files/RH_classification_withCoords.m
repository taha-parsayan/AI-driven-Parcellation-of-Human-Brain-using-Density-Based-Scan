...
label_6500 = mydbscan(RH_vertex_6500, 100, 4.65);
disp('label_6500:');
...
label_660700 = mydbscan(RH_vertex_660700, 100, 5.1);
disp('label_660700:');
...
label_1316060 = mydbscan(RH_vertex_1316060, 100, 4.75);
disp('label_1316060:');
...
label_1326300 = mydbscan(RH_vertex_1326300, 100, 4.8);
disp('label_1326300:');
...
label_1351760 = mydbscan(RH_vertex_1351760, 100, 4.15);
disp('label_1351760:');
...
label_2146559 = mydbscan(RH_vertex_2146559, 100, 4.55);
disp('label_2146559:');
...
label_2647065 = mydbscan(RH_vertex_2647065, 100, 5.5);
disp('label_2647065:');
...
label_3296035 = mydbscan(RH_vertex_3296035, 100, 4.2);
disp('label_3296035:');
...
label_3302420 = mydbscan(RH_vertex_3302420, 100, 5.1);
disp('label_3302420:');
...
label_3302560 = mydbscan(RH_vertex_3302560, 100, 4.9);
disp('label_3302560:');
...
label_3957880 = mydbscan(RH_vertex_3957880, 100, 3.7);
disp('label_3957880:');
...
label_3988500 = mydbscan(RH_vertex_3988500, 100, 5.1);
disp('label_3988500:');
...
label_3988540 = mydbscan(RH_vertex_3988540, 100, 4.5);
disp('label_3988540:');
...
label_4924360 = mydbscan(RH_vertex_4924360, 100, 3.91);
disp('label_4924360:');
...
label_6553700 = mydbscan(RH_vertex_6553700, 100, 4.45);
disp('label_6553700:');
...
label_6558940 = mydbscan(RH_vertex_6558940, 100, 4.04);
disp('label_6558940:');
...
label_7874740 = mydbscan(RH_vertex_7874740, 100, 5.2);
disp('label_7874740:');
...
label_8204875 = mydbscan(RH_vertex_8204875, 100, 4.2);
disp('label_8204875:');
...
label_9180240 = mydbscan(RH_vertex_9180240, 100, 4.7);
disp('label_9180240:');
...
label_9180300 = mydbscan(RH_vertex_9180300, 100, 4.1);
disp('label_9180300:');
...
label_9182740 = mydbscan(RH_vertex_9182740, 100, 4.1);
disp('label_9182740:');
...
label_9211105 = mydbscan(RH_vertex_9211105, 100, 4.3);
disp('label_9211105:');
...
label_9221140 = mydbscan(RH_vertex_9221140, 100, 4.41);
disp('label_9221140:');
...
label_9221340 = mydbscan(RH_vertex_9221340, 100, 4.7);
disp('label_9221340:');
...
label_9231540 = mydbscan(RH_vertex_9231540, 100, 5.5);
disp('label_9231540:');
...
label_10511485 = mydbscan(RH_vertex_10511485, 100, 4.2);
disp('label_10511485:');
...
label_10542100 = mydbscan(RH_vertex_10542100, 100, 4.2);
disp('label_10542100:');
...
label_11146310 = mydbscan(RH_vertex_11146310, 100, 4.3);
disp('label_11146310:');
...
label_11832480 = mydbscan(RH_vertex_11832480, 100, 4.25);
disp('label_11832480:');
...
label_13145750 = mydbscan(RH_vertex_13145750, 100, 5.1);
disp('label_13145750:');
...
label_14423100 = mydbscan(RH_vertex_14423100, 100, 4.2);
disp('label_14423100:');
...
label_14433500 = mydbscan(RH_vertex_14433500, 100, 4.17);
disp('label_14433500:');
...
label_14464220 = mydbscan(RH_vertex_14464220, 100, 3.8);
disp('label_14464220:');
...
label_14474380 = mydbscan(RH_vertex_14474380, 100, 4.72);
disp('label_14474380:');
